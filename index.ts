...
const quiz: Question[] = [
  ...
  {
    question:
      "In the Disney movie Frozen, who has the magical ability to control ice and snow?",
    choices: ["Elsa", "Anna", "Olaf"],
    correctAnswer: "Elsa",
  },
  {
    question:
      "What is the name of the world's largest social media platform founded by Mark Zuckerberg?",
    choices: ["Instagram", "Twitter", "Facebook"],
    correctAnswer: "Facebook",
  },
  {
    question:
      "Which famous TV show features dragons, direwolves, and the Iron Throne?",
...
async function main() {
  ...
  for (const question of quiz) {
    ...
    const answer = await inquirer.prompt<{userAnswer: String;}>([
      {
        name: "userAnswer",
        type: "list",
    ...
    console.log(
      `Quiz completed! Your score: ${chalk.yellow.bold(`${score}/${quiz.length}`)}`
